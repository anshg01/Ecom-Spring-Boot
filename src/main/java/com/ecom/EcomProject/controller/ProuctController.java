...
public class ProuctController {
    ...
    public ResponseEntity<List<Product>> searchProductsByName(@RequestParam String searchedQuery) {
        List<Product> products = productService.searchProductsByQuery(searchedQuery);
